System.register(['angular2/platform/browser', './app.component', 'angular2/http', "angular2/core", "angular2/router"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ...
            browser_1.bootstrap(app_component_1.AppComponent, [http_1.HTTP_BINDINGS, router_1.ROUTER_PROVIDERS, core_1.bind(router_1.LocationStrategy).toClass(router_1.HashLocationStrategy)]);
        }
    }
});
